...
#define MOTOR_AZ_FORWARD IOPORT_CREATE_PIN(PIOC, 13)    // Pin 50
#define MOTOR_AZ_REVERSE IOPORT_CREATE_PIN(PIOC, 15)  // Pin 48
#define MOTOR_AZ_ENC_1 IOPORT_CREATE_PIN(PIOC, 17) // Pin 46
#define MOTOR_AZ_ENC_2 IOPORT_CREATE_PIN(PIOC, 19) // Pin 44

#define MOTOR_ALT_FORWARD IOPORT_CREATE_PIN(PIOC, 12)    // Pin 51
#define MOTOR_ALT_REVERSE IOPORT_CREATE_PIN(PIOC, 14)  // Pin 49
#define MOTOR_ALT_ENC_1 IOPORT_CREATE_PIN(PIOC, 16) // Pin 47
#define MOTOR_ALT_ENC_2 IOPORT_CREATE_PIN(PIOC, 18) // Pin 45
